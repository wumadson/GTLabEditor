    ...
    : QWidget(parent)
{
    ...
    setStyleSheet(QString(
        ...
        "QPushButton#SystemInputProfileButton:pressed{color:%2;background:#070A0D;}"
        ...
        "QWidget#SystemWorkspace QComboBox{min-height:32px;padding:0 30px 0 9px;color:%2;"
        ...
        "QWidget#SystemWorkspace QComboBox::drop-down{border:0;border-left:1px solid %5;width:26px;}"
        ...
        "QWidget#SystemWorkspace QComboBox QAbstractItemView::item{min-height:26px;padding:2px 7px;}"
